...
function Iletisim() {
  useDocumentTitle("İletişim - Adıyaman Blue Liva Güzellik Güzellik Salonu ");
  return (
      ...
      <div class="col-lg-6s col-md-6 col-sm-12 col-12" style={{}}>
        <div class="row" style={{}}>
          <div class="col-lg-6s col-md-6 col-sm-12 col-12">
            ...
            ></img>
            <p className="contactText"><b>Adres:</b><br/> Hoca Ömer Mah. 215 Sok Şatoser İş Merkezi No:4 Kat:3/5  Merkez / Adıyaman </p>
          </div>
          <div class="col-lg-6s col-md-6 col-sm-12 col-12">
            <img
              src={i2}
              ...
              title="Epilasyon Konum"
            ></img>
            <p className="contactText"><b>Rezervasyon:</b> <br/>0506 171 27 02</p>
          </div>
          <div class="col-lg-6s col-md-6 col-sm-12 col-12">
            <img
              src={i3}
          ...
          <div class="col-lg-6s col-md-6 col-sm-12 col-12">
            <img
              ...
              title="Epilasyon Konum"
            ></img>
            <p className="contactText"><b>WhatsApp:</b> <br/>0506 171 27 02</p>
          </div>
        </div>
      </div>
