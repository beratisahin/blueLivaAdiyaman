...
function Hakkimizda() {
  useDocumentTitle("Adıyaman Blue Liva Güzellik Güzellik Salonu");
  return (
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            ...
            yüzlü ekibi ile estetik ve güzellik sektöründe Adıyaman’da merkezi
            ...
            kavuşuyorsunuz. Ailenizden biri olmayı amaçlayan Adıyaman Lavinya Golden
          ...
          <p class="hizmetyazi">
            ...
            olmak için emin adımlarla, şehrin gözdesi Adıyaman merkezde ileri seviye hizmet vermektedir. Kadın ve erkeklere özel
            ayrı salonlarımızda, memnuniyet ve sonuç odaklı profesyonel
            uygulamalar yapıyoruz.
          </p>

          <p class="hizmetyazi">
            Adıyaman Blue Liva Güzellik Güzellik Salonu olarak Lazer Epilasyon, G5
            Masajı, Kavitasyon, Kirpik Lifting, Yosun Peeling,
            Hydrafacial Cilt Bakımı hizmetlerimiz mevcuttur. Kampanyalarımız ve
            detaylar için sosyal medya hesaplarımızı takipte kalın. Adıyaman
            ...
            müşterimize hizmet verebilmekteyiz.
                ...
                <p className="instaLink" style={{textAlign:"center",color:"gray"}}>Detaylı güncel fotoğraf ve videolar için <a className="instagram"  href="https://www.instagram.com/blue.liva.adiyaman/" target="_blank">Adıyaman Blue Liva Güzellik Güzellik Salonu</a> instagram profilimizi ziyaret edebilirsiniz. </p>
